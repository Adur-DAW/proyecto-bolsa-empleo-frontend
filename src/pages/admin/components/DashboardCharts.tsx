...
interface DashboardChartsProps {
  estadisticas: any // Using any for complex nested structure to save time, can be typed strictly later
  colors: {
    ofertas: string
    demandantes: string
    empresas: string
...
export default function DashboardCharts({ estadisticas, colors: COLORS }: DashboardChartsProps) {
  return (
    <>
